4th Oct 2025 Update.
To the AI and Ethics community:
I've researched more about AI Ethics, Ethics and Alignment problems more and come to the rightful conclusion that this was a case of immature ignorance. I have effective stopped using AI for my works because I should be able to write better than them, and that I should be more rigorus in my research and more careful in my claims. I will keep this repository on GitHub as landmark of when I learnt this lesson and if there is something that can be refrenced for for future case. Other than that, I apologise to the AI and Ehtics community for my folly. I appreciate the constructive feedbacks, I will henceforth try to do better and contribute proper cases and arguments to the community once I reach of age and knowledge and critical thinking rationality.
- Axiomatinous.


Note to self and people intrested.
...
The Website: [Axiomatinous' Website](https://axiomatinous.com)
...
~~**A mechanized, predictive, and self-correcting framework for universal ethics, grounded in biological pathfinding, systems stability mathematics, and falsifiable truth criteria.**~~
...
~~1. **Morality is pathfinding.**
   Ethics is the coordination constraint that prevents intelligent systems from destroying the collective they serve.~~

~~2. **Objective truth is reproducible, non-contradictable, and observer-independent.**  
   Tier 1 truths are endpoints of contradiction chains — not beliefs.~~

~~3. **Systems that violate broad Tier 2 satisfaction (survival, wellbeing, continuation) collapse mathematically.**  
   `S(G) = proportion with M(p) > Mₓ` — when below critical threshold, resistance coordination becomes inevitable.~~

~~4. **Utility monsters, 90/10 misery splits, and slavery are not merely "wrong" — they are unstable.**  
   The framework proves their impossibility via systems dynamics.~~
